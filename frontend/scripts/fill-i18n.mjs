...
const T = {
  ...
  'ChatFiles.hydrating': { en: 'Loading decision state…', it: 'Caricamento stato decisione…', fr: 'Chargement de l\'état de décision…', de: 'Entscheidungsstatus wird geladen…', es: 'Cargando estado de decisión…', pt: 'A carregar estado de decisão…' },
